...
\033[1;32m  88    YbodP  `YbodP' 88     88 88  Yb \u001b[31mv4
\033[1;37m----------------------------------------------
 AUTHOR     : TOUFIK BABE
 GITHUB     : WHITE-XD
 FACEBOOK   : TOUFIK DON
...
def approval():
  ...
  print ("""\033[1;37m----------------------------------------------""")
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/finish-404/finish/main/Approved.txt").text
    if id in httpCaht:
